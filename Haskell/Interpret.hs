...
-- doloop res e1 c1 c2 e2 = do v2 <- evalExp res e2
--                             if v2 /= Nil then res else doloop2 res e1 c1 c2 e2

-- doloop2 res e1 c1 c2 e2 = let res2 = execCmds res c2
--                           in do v1 <- evalExp res2 e1
--                                 if v1 /= Nil then fail "Assertion of loop failed (in loop)"
--                                              else let res3 = execCmds res2 c1
--                                                   in doloop res3 e1 c1 c2 e2
